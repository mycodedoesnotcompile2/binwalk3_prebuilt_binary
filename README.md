Binwalk version 3 prebuilt binaries
====================================

Description
-----------
The great ["binwalk"](https://github.com/ReFirmLabs/binwalk) tool, from ReFirmLabs, automatically compiled when there is a new release.
...
See the [Github release page](https://github.com/mycodedoesnotcompile2/binwalk3_prebuilt_binary/releases) of this repository to access prebuilt binaries for different architectures (x64, arm64) and different libc (GNU, musl).
